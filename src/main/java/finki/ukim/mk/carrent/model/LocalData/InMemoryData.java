...
public class InMemoryData {
    ...
    public void init(){
        ...
        termins.add(new Termin(0L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car1));
        termins.add(new Termin(1L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car2));
        termins.add(new Termin(2L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car3));
        termins.add(new Termin(3L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car4));
        termins.add(new Termin(4L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car5));
        termins.add(new Termin(5L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car6));
        termins.add(new Termin(6L, LocalDate.now(), LocalDate.of(2025, Month.APRIL, 1), car7));
